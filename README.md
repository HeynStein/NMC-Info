...
- **[Privacy Policy](PRIVACY.md)** — local storage, on-page behavior (including extension CSS and inline adjustments on specific elements), optional **Report bug** submissions (Google Forms: **base site URL** only, not the full page address; short system summary, not the full raw User-Agent string), and related details.
